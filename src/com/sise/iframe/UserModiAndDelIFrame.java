...
import com.sise.JComPz.Item;
import com.sise.dao.Dao;
import com.sise.model.user;
import com.sise.util.MyDocument;
...
public class UserModiAndDelIFrame extends JInternalFrame {
	...
	private Object[][] getFileStates(List list){
		String[] str = { "用户编号", "用户姓名", "性别", "年龄", "押金", "办证日期",
				"电话", "密码" };
	...
	public UserModiAndDelIFrame() {
		...
		str = new String[]{"用户编号", "用户姓名", "性别", "年龄", "押金", "办证日期",
				"电话", "密码" };
